  ...
  return (
    <>
      <button 
        ...
        className="flex items-center gap-2 rounded-2xl bg-white px-6 py-3 text-sm font-medium text-orange-600 transition hover:bg-white/90"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-2xl bg-slate-50 shadow-2xl">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      className="h-12 rounded-xl border-slate-300 pl-10 text-slate-900 placeholder:text-slate-400"
